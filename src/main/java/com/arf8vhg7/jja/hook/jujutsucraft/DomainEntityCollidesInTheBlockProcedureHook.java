...
public final class DomainEntityCollidesInTheBlockProcedureHook {
    private DomainEntityCollidesInTheBlockProcedureHook() {
    }
    ...
    public static double resolveAdaptationProgress(Entity entity, Entity ownerEntity, String key, double originalValue) {
        return MahoragaAdaptation.resolveRegistrationProgress(entity, key, originalValue, ownerEntity, true);
    }
