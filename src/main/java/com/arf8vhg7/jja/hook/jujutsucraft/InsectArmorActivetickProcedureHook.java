...
public final class InsectArmorActivetickProcedureHook {
    private InsectArmorActivetickProcedureHook() {
    }
    ...
    public static boolean addHiddenEffect(LivingEntity livingEntity, MobEffectInstance effectInstance) {
        return livingEntity.addEffect(InsectArmorEffectVisibility.normalize(effectInstance));
    }
