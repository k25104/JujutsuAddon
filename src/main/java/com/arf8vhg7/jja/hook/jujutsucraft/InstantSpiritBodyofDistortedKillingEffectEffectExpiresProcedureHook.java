...
public final class InstantSpiritBodyofDistortedKillingEffectEffectExpiresProcedureHook {
    private InstantSpiritBodyofDistortedKillingEffectEffectExpiresProcedureHook() {
    }
