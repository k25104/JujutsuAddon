...
public final class InstantSpiritBodyofDistortedKillingEffectOnEffectActiveTickProcedureHook {
    private InstantSpiritBodyofDistortedKillingEffectOnEffectActiveTickProcedureHook() {
    }
