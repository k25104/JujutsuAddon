...
public final class SkillKashimoKickProcedureHook {
    private SkillKashimoKickProcedureHook() {
    }

    public static boolean isStillCharging(Entity entity, boolean original) {
        return ZoneChargeScalingService.isCnt6StillCharging(entity, original);
    }
