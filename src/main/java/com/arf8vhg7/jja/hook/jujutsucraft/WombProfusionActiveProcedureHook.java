...
public final class WombProfusionActiveProcedureHook {
    private WombProfusionActiveProcedureHook() {
    }
    ...
    public static double adjustDomainRange(LivingEntity livingEntity, double radius) {
        return DomainExpansionHookSupport.adjustOpenBarrierRange(livingEntity, radius, 9.0);
    }
