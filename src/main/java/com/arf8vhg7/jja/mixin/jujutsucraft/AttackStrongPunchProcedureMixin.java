...
import com.arf8vhg7.jja.hook.jujutsucraft.AttackStrongPunchProcedureHook;
import com.llamalad7.mixinextras.injector.wrapoperation.Operation;
import com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation;
import com.llamalad7.mixinextras.sugar.Local;
import java.util.function.Consumer;
import javax.annotation.Nullable;
import net.mcreator.jujutsucraft.procedures.AttackStrongPunchProcedure;
...
@Mixin(value = AttackStrongPunchProcedure.class, remap = false)
public abstract class AttackStrongPunchProcedureMixin {
    @WrapOperation(
        method = "execute",
        at = @At(
            value = "INVOKE",
    ...
    private static @Nullable Entity jja$replaceAttackStrikeEntity(
        ...
        return AttackStrongPunchProcedureHook.replaceAttackStrikeEntity(level, entity, xPos, yPos, zPos, range);
    }
}
