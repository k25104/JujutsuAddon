...
import com.arf8vhg7.jja.hook.jujutsucraft.Effect3ProcedureHook;
import com.llamalad7.mixinextras.injector.wrapoperation.Operation;
import com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation;
import com.llamalad7.mixinextras.sugar.Local;
import net.mcreator.jujutsucraft.procedures.Effect3Procedure;
...
@Mixin(value = Effect3Procedure.class, remap = false)
@SuppressWarnings("deprecation")
public abstract class Effect3ProcedureMixin {
    @WrapOperation(
        method = "execute",
        at = @At(
            value = "INVOKE",
    ...
    private static ItemStack jja$resolveCuriosEquipmentRead(
        ...
        return Effect3ProcedureHook.resolveEquipmentRead(livingEntity, equipmentSlot, original.call(livingEntity, equipmentSlot));
    }
    ...
    private static Object jja$equipManagedViaCuriosOnPlayerSet(
        ...
        if (stack instanceof ItemStack itemStack
            && Effect3ProcedureHook.handlePlayerArmorInventorySet(entityIterator, armorIndex, itemStack)) {
            return stack;
        }
    ...
    private static void jja$equipManagedViaCuriosOnLivingSet(
        ...
        if (!Effect3ProcedureHook.handleLivingArmorSet(livingEntity, equipmentSlot, stack)) {
